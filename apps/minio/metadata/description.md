> Warning ⚠️: MinIO decided to [rug-pull](https://github.com/minio/minio/issues/21647) on the open-source community. Please use something else like [GarageHQ](https://garagehq.deuxfleurs.fr/).
